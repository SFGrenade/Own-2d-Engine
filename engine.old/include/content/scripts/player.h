...
class Player : public SFG::Engine::ScriptCollider {
  ...
  bool rendering_;
  UTILS_ALIGN( 64 ) bool pressesUp_;       // used for input and logic
  UTILS_ALIGN( 64 ) bool pressesDown_;     // used for input and logic
  UTILS_ALIGN( 64 ) bool pressesLeft_;     // used for input and logic
  UTILS_ALIGN( 64 ) bool pressesRight_;    // used for input and logic
  UTILS_ALIGN( 64 ) SDL_Rect playerRect_;  // used for graphics and logic
