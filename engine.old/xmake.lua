...
add_requireconfs( "centurion", { configs = { pragma_once = true, debug_macros = false, sdl_image = true, sdl_mixer = true, sdl_ttf = true, vulkan = true, opengl = true } } )
...
target( "Own-2d-Engine" )
  ...
  add_packages( "centurion", { public = true } )
