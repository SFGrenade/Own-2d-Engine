    ...
    if( this->get_moved_bottom( deltaTime ) >= other->get_moved_top( deltaTime )
      ...
      if( this->get_right() > other->get_left() && this->get_left() < other->get_right() ) {
        ...
        if( !other->isTrigger_ ) {
          ...
          this->velocity_.set_y( std::min( this->velocity_.y(), 0.0L ) );
        }
      ...
      if( this->get_right() > other->get_left() && this->get_left() < other->get_right() ) {
        ...
        if( !other->isTrigger_ ) {
          ...
          this->velocity_.set_y( std::max( this->velocity_.y(), 0.0L ) );
        }
    ...
    if( this->get_moved_right( deltaTime ) >= other->get_moved_left( deltaTime )
      ...
      if( this->get_bottom() > other->get_top() && this->get_top() < other->get_bottom() ) {
        ...
        if( !other->isTrigger_ ) {
          ...
          this->velocity_.set_x( std::min( this->velocity_.x(), 0.0L ) );
        }
      ...
      if( this->get_bottom() > other->get_top() && this->get_top() < other->get_bottom() ) {
        ...
        if( !other->isTrigger_ ) {
          ...
          this->velocity_.set_x( std::max( this->velocity_.x(), 0.0L ) );
        }
