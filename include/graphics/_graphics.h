...
class Graphics {
  ...
  void add_Update_Performance_String_callback( std::function< void( SFG::Proto::InProc::Update_Performance_String_Request const& ) > callback );
  ...
  std::vector< std::function< void( SFG::Proto::InProc::Update_Performance_String_Request const& ) > > update_performance_string_callbacks_;
};
}  // namespace SFG
