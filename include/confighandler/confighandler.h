...
class ConfigHandler {
  ...
  static uint16_t config_Font_PixelSize;
  static uint16_t config_Input_StopGameKey;
  ...
  static uint16_t config_Window_Width;
  static uint16_t config_Window_Height;
  static uint32_t config_Audio_SampleRate;
  static uint32_t config_Audio_Format;
  static uint16_t config_Audio_Channels;
  ...
  static uint16_t get_Font_PixelSize();
  static uint16_t get_Input_StopGameKey();
  ...
  static uint32_t get_Audio_Format();
  static uint16_t get_Audio_Channels();
